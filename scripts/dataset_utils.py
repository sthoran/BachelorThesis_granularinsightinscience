...
if __name__ == '__main__':
    train_data = load_scierc('/Users/user/IUBH/Semester6/Bachlorthesis/code/data/processed_data/json/train.json')
    test_data = load_scierc('/Users/user/IUBH/Semester6/Bachlorthesis/code/data/processed_data/json/test.json')
    dev_data = load_scierc('/Users/user/IUBH/Semester6/Bachlorthesis/code/data/processed_data/json/dev.json')
